    ...
    <div className="min-h-screen w-full lg:grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between bg-gradient-to-br from-brand-900 to-brand-950 p-10 text-white relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
           <div className="p-2 bg-white/10 backdrop-blur rounded-lg border border-white/10">
             <CircuitBoard size={24} className="text-accent-cyan" />
           </div>
           <span className="text-xl font-bold tracking-tight">Trade<span className="text-brand-300">Matrix</span> MIS</span>
        </div>
      ...
      <div className="flex items-center justify-center p-6 bg-zinc-50 dark:bg-zinc-950 transition-colors duration-300">
        <div className="w-full max-w-[400px] space-y-6">
           ...
           <div className="lg:hidden flex items-center gap-2 mb-8 justify-center text-zinc-900 dark:text-white">
